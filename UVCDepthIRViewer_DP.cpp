...
// UI
#include "Render.h"
#include "VCLab_Render.h"

// VCLab
#include "VCLab/VCLab_utils.h"

// window handle
VCLab_Render* g_pRender = NULL;
...
// window callback, called by VCLab_Render::display()
...
//        g_pRender->draw(-1, (uint8_t*)s_colorImage, g_width * g_height, pFrame->width, pFrame->height, &pFrame);
...
int main(int argc, char** argv)
{
    ...
    g_pRender = new VCLab_Render(nullptr, 0, 0, "UVCDepthIRViewer", g_width * 3, g_height); // window title & size

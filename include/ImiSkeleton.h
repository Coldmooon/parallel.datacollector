...
//IMINECT_EXP void imiConvertCoordinateDepthToWorld(ImiVector4* dst, const ImiVector4I* src, int32_t height, int32_t width);
//IMINECT_EXP void imiConvertCoordinateWorldToDepth(ImiVector4I* dst, const ImiVector4* src, int32_t height, int32_t width);
 ...
 **/
IMINECT_EXP int32_t imiSelectUser(const ImiDeviceHandle device, uint32_t userId);
 ...
 * @return 0: success, < 0 : error
 **/
IMINECT_EXP int32_t imiUnSelectUser(const ImiDeviceHandle device, uint32_t userId);
 ...
 * @return 0: success, < 0 : error
 **/
IMINECT_EXP int32_t imiMirrorSkeleton(ImiSkeletonData* pSkeletonData);
 ...
 * @return 0: success, < 0 : error
 **/
IMINECT_EXP int32_t imiGetUserColorSegment(const int32_t* userId, const uint8_t length, ImiCoordinateConvertMode type, uint8_t* userDepth, uint8_t* userColor);
 ...
 * @return 0: success, < 0 : error
 **/
IMINECT_EXP int32_t imiGetSkeletonJointOrientation(const ImiSkeletonData* pSkeletonData, ImiSkeletonJointOrientation* pJointOrientation);

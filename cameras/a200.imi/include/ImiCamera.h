 ...
 * return 0: success, < 0 : error
 **/
IMICAMERA_EXP const ImiCameraFrameMode* imiCamGetCurrentFrameMode(ImiCameraHandle cameraDevice);
 ...
 * @return 0: success, < 0 : error
 **/
IMICAMERA_EXP int32_t imiCamSetFrameMode(ImiCameraHandle cameraDevice, ImiCameraFrameMode* pMode);
 ...
 * return 0: success, < 0 : error
 **/
IMICAMERA_EXP int32_t imiCamStartStream2(ImiCameraHandle cameraDevice);
...
IMICAMERA_EXP int32_t imiCamSetRGB2Gray(ImiCameraHandle cameraDevice, bool bEnable);

IMICAMERA_EXP int32_t imiCamSetRotationAngle(ImiCameraHandle cameraDevice, ImiCameraRotationAngle rotationAngle);
